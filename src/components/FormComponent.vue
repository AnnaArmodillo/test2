...
<template>
    <form class="form">
        <div class="form__input">
            <MultipleSelectInput field="posts" :setOptions="setOptions" placeholder="Выберите значения" :values="values.posts" :options="options.posts"
            :enableCreate="true" :showChosen="true">
        </MultipleSelectInput>
    </div>
    <div class="form__input form__input_full-width">
        <MultipleSelectInput field="todos" :setOptions="setOptions" placeholder="Выберите значения" :values="values.todos" :options="options.todos"
        :enableCreate="true" :showChosen="true">
    </MultipleSelectInput>
</div>
